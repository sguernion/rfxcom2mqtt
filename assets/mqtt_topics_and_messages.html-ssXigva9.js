import{_ as a}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o as i,c as o,a as n,b as e,d as c,w as d,e as l}from"./app-o4ioxQG5.js";const r={},u=n("h1",{id:"mqtt-topics-and-messages",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#mqtt-topics-and-messages"},[n("span",null,"MQTT Topics and Messages")])],-1),p=n("code",null,"rfxcom2MQTT",-1),m=n("code",null,"config.yaml",-1),v=l(`<h2 id="rfxcom2mqtt-bridge-info" tabindex="-1"><a class="header-anchor" href="#rfxcom2mqtt-bridge-info"><span>rfxcom2MQTT/bridge/info</span></a></h2><p>Contains information of the bridge. Whenever one of the attributes in the payload changes, this is republished. Example payload:</p><div class="language-json line-numbers-mode" data-ext="json" data-title="json"><pre class="language-json"><code><span class="token punctuation">{</span>
